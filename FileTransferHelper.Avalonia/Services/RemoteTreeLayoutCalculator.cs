...
public static class RemoteTreeLayoutCalculator
{
    ...
    public static double MeasurePaneWidth(IEnumerable<RemoteTreeNode> roots, double minWidth, double maxWidth)
    {
        var widest = minWidth;
    ...
    private static void WalkVisible(RemoteTreeNode node, int depth, ref double widest)
    {
